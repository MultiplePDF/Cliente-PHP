    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4" style="text-align: center;">
                ...
                <p style="text-align: center;">Tus archivos han sido <br>transformados.&nbsp;<br>Se estan descargando ahora mismo</p><button class="btn btn-primary" type="button" style="text-align: center;background: rgb(255,119,100);padding: 5px 9px;">Descargar</button>
            </div>
